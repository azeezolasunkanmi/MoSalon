export const navLinks = [
  ...
  { id: "price", title: "Price List", to: "price" },
  { id: "training", title: "Training", to: "training" },
  { id: "inspo", title: "Inspo", to: "inspo" },
  { id: "booknow", title: "Book now", to: "booknow" },
];

// HERO SECTION

// import image1 from "../assets/background/bghero1.jpg";
import image2 from "../assets/background/bghero2.jpg";
import image3 from "../assets/background/bghero3.jpg";
// import image4 from "../assets/background/bghero4.jpg";
export const heroContent = [
  {
    title1: "Be You.",
    title2: "Be Beautiful.",
    description: "Transforming the nail experience 🩷",
    image: image2,
  },
  {
    title1: "Escape from",
    title2: "everyday routine.",
    description: "A wonderful nail experience 🩷",
    image: image3,
  },
  // {
  //   title1: "Trending.",
  //   title2: "Biab Nails.",
  //   description: "Join the bandwagon 🩷",
  //   image: image1,
  // },
  // {
  //   title1: "Welcome to",
  //   title2: "The Nail Artistry.",
  //   description: "Where creativity meets craftmanship 🩷",
  //   image: image4,
  // },
];

// ABOUT US
import img1 from "../assets/aboutUs/manicure.svg";
import img2 from "../assets/aboutUs/nail.svg";
import img3 from "../assets/aboutUs/nailpolish.svg";
import img4 from "../assets/aboutUs/pedicure.svg";
...
export const nailsServicesAndPrices = [
  { name: "STICK ON WITH GEL", price: "15 000", category: "stick-on" },
  { name: "ACRYLIC OVERLAY", price: "17 000", category: "acrylic" },
  { name: "PLAIN ACRYLIC SET", price: "20 000", category: "acrylic" },
  { name: "FRENCH TIPS", price: "30 000", category: "acrylic" },
  { name: "BIAB NAILS", price: "20 000", category: "biab" },
  { name: "GEL X", price: "17 000", category: "gel-x" },
  { name: "OMBRE/MARBLE", price: "25 000", category: "stick-on" },
  { name: "INFILL", price: "18 000", category: "acrylic" },
  { name: "FIXING OF TOES", price: "10 000", category: "gel" },
  { name: "FRENCH TIPS ON TOES", price: "12 000", category: "stick-on" },
  ...
  { name: "SOAK OFF", price: "5000", category: "maintenance" },
];
...
export const training = [
  {
    ...
    outline: [
      ...
      "Health and Salon safety",
      "Nail Anatomy and Physiology",
      "Nail Preparation",
      "Tip Application and Sizing",
      "Filling and Shaping",
      ...
      "Stick On",
      "Ombre Application",
      "Marble (Gel and Acrylic)",
      "Acrylic on toes",
      "3D Flowers",
      "Removal and Refills",
      "Encapsulation",
      "French tips (Gel and Acrylic)",
    ],
  },
  {
    title: "Standard",
